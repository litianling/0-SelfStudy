...
set C_modelArgList {
	...
	{ fc_in_1_0 float 32 regular {array 36 { 2 3 } 1 1 } {global 2}  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "8", "11", "14", "17", "18", "19", "20", "21", "22", "23", "24", "25"],
		...
		"Port" : [
			{"Name" : "mnist_data", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_Conv2d_4_fu_419", "Port" : "input_matrix"}]},
			{"Name" : "conv_kernel_1", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_Conv2d_4_fu_419", "Port" : "kernel"}]},
			{"Name" : "conv_out_1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_MaxPool2d_1_fu_399", "Port" : "conv_out_1"},
					{"ID" : "11", "SubInstance" : "grp_Conv2d_4_fu_419", "Port" : "out_matrix"}]},
			{"Name" : "max_poo_out_1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_MaxPool2d_1_fu_399", "Port" : "output_matrix"},
					{"ID" : "14", "SubInstance" : "grp_Conv2d_3_fu_429", "Port" : "input_matrix"}]},
			{"Name" : "max_poo_locate_1", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_MaxPool2d_1_fu_399", "Port" : "locate_matrix"}]},
			{"Name" : "conv_kernel_2", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_Conv2d_3_fu_429", "Port" : "kernel"}]},
			{"Name" : "conv_out_2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_MaxPool2d_fu_409", "Port" : "conv_out_2"},
					{"ID" : "14", "SubInstance" : "grp_Conv2d_3_fu_429", "Port" : "out_matrix"}]},
			{"Name" : "max_poo_out_2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_MaxPool2d_fu_409", "Port" : "output_matrix"}]},
			{"Name" : "max_poo_locate_2", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_MaxPool2d_fu_409", "Port" : "locate_matrix"}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_MaxPool2d_1_fu_399", "Parent" : "0", "Child" : ["6", "7"],
		"CDFG" : "MaxPool2d_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_MaxPool2d_1_fu_399.forw_back_sitofp_dEe_U8", "Parent" : "5"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_MaxPool2d_1_fu_399.forw_back_fcmp_32eOg_U9", "Parent" : "5"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_MaxPool2d_fu_409", "Parent" : "0", "Child" : ["9", "10"],
		"CDFG" : "MaxPool2d",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_MaxPool2d_fu_409.forw_back_sitofp_dEe_U20", "Parent" : "8"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_MaxPool2d_fu_409.forw_back_fcmp_32eOg_U21", "Parent" : "8"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Conv2d_4_fu_419", "Parent" : "0", "Child" : ["12", "13"],
		"CDFG" : "Conv2d_4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Conv2d_4_fu_419.forw_back_fadd_32bkb_U1", "Parent" : "11"},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Conv2d_4_fu_419.forw_back_fmul_32cud_U2", "Parent" : "11"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Conv2d_3_fu_429", "Parent" : "0", "Child" : ["15", "16"],
		"CDFG" : "Conv2d_3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "kernel", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "out_matrix", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Conv2d_3_fu_429.forw_back_fadd_32bkb_U15", "Parent" : "14"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Conv2d_3_fu_429.forw_back_fmul_32cud_U16", "Parent" : "14"},
...
set Spec2ImplPortList { 
	...
	fc_in_1_0 { ap_memory {  { fc_in_1_0_address0 mem_address 1 6 }  { fc_in_1_0_ce0 mem_ce 1 1 }  { fc_in_1_0_we0 mem_we 1 1 }  { fc_in_1_0_d0 mem_din 1 32 }  { fc_in_1_0_q0 mem_dout 0 32 } } }
