...
set C_modelArgList {
	{ output_matrix float 32 regular {array 36 { 0 3 } 0 1 }  }
	{ locate_matrix float 32 regular {array 36 { 0 3 } 0 1 }  }
	{ conv_out_2 float 32 regular {array 144 { 1 3 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ output_matrix_address0 sc_out sc_lv 6 signal 0 } 
	...
	{ locate_matrix_address0 sc_out sc_lv 6 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_matrix_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "output_matrix", "role": "address0" }} , 
 	...
 	{ "name": "locate_matrix_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "locate_matrix", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_sitofp_dEe_U20", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_fcmp_32eOg_U21", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	output_matrix { ap_memory {  { output_matrix_address0 mem_address 1 6 }  { output_matrix_ce0 mem_ce 1 1 }  { output_matrix_we0 mem_we 1 1 }  { output_matrix_d0 mem_din 1 32 } } }
	locate_matrix { ap_memory {  { locate_matrix_address0 mem_address 1 6 }  { locate_matrix_ce0 mem_ce 1 1 }  { locate_matrix_we0 mem_we 1 1 }  { locate_matrix_d0 mem_din 1 32 } } }
	conv_out_2 { ap_memory {  { conv_out_2_address0 mem_address 1 8 }  { conv_out_2_ce0 mem_ce 1 1 }  { conv_out_2_q0 mem_dout 0 32 } } }
}
