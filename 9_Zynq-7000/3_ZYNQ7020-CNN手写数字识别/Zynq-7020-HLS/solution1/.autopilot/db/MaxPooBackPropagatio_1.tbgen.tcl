set moduleName MaxPooBackPropagatio_1
set isTopModule 0
...
set C_modelName {MaxPooBackPropagatio.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_matrix float 32 regular {array 196 { 1 3 } 1 1 }  }
	{ output_matrix float 32 regular {array 784 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ max_poo_locate_1_address0 sc_out sc_lv 8 signal 2 } 
	{ max_poo_locate_1_ce0 sc_out sc_logic 1 signal 2 } 
	{ max_poo_locate_1_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1654", "Max" : "1654"}
	, {"Name" : "Interval", "Min" : "1654", "Max" : "1654"}
]}
...
set Spec2ImplPortList { 
	...
	output_matrix { ap_memory {  { output_matrix_address0 mem_address 1 10 }  { output_matrix_ce0 mem_ce 1 1 }  { output_matrix_we0 mem_we 1 1 }  { output_matrix_d0 mem_din 1 32 } } }
