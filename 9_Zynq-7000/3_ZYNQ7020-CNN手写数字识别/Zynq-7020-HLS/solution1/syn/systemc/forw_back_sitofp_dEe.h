...
// ==============================================================
#ifndef __forw_back_sitofp_dEe__HH__
#define __forw_back_sitofp_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_sitofp_dEe) {
    ...
    SC_CTOR(forw_back_sitofp_dEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
