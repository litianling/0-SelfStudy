...
// ==============================================================
#ifndef __forw_back_fcmp_32eOg__HH__
#define __forw_back_fcmp_32eOg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_fcmp_32eOg) {
    ...
    SC_CTOR(forw_back_fcmp_32eOg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
