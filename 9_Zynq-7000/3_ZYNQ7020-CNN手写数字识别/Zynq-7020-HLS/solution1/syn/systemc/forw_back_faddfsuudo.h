...
// ==============================================================
#ifndef __forw_back_faddfsuudo__HH__
#define __forw_back_faddfsuudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_faddfsuudo) {
    ...
    SC_CTOR(forw_back_faddfsuudo):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
