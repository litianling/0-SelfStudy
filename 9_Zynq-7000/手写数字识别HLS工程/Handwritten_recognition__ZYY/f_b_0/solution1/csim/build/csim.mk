...
HLS_SOURCES = ../../../main.c ../../../forw_back.c
...
$(ObjDir)/forw_back.o: ../../../forw_back.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../forw_back.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/forw_back.d
