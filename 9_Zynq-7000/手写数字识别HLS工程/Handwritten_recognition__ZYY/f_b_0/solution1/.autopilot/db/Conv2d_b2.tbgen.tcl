...
set C_modelName {Conv2d_b2}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_matrix float 32 regular {array 784 { 1 3 } 1 1 }  }
	{ kernel float 32 regular {array 9 { 1 3 } 1 1 }  }
	{ out_matrix float 32 regular {array 676 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ out_matrix_address0 sc_out sc_lv 10 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_matrix_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "out_matrix", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_fadd_32bkb_U61", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_fmul_32cud_U62", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_mac_muldEe_U63", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	out_matrix { ap_memory {  { out_matrix_address0 mem_address 1 10 }  { out_matrix_ce0 mem_ce 1 1 }  { out_matrix_we0 mem_we 1 1 }  { out_matrix_d0 mem_din 1 32 } } }
}
