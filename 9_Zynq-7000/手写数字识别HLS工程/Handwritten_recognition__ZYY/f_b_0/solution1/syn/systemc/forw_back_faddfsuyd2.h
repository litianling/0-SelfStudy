...
// ==============================================================
#ifndef __forw_back_faddfsuyd2__HH__
#define __forw_back_faddfsuyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_faddfsuyd2) {
    ...
    SC_CTOR(forw_back_faddfsuyd2):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
