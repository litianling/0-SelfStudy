...
// ==============================================================
#ifndef __forw_back_mac_muldEe__HH__
#define __forw_back_mac_muldEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_mac_muldEe) {
    ...
    SC_CTOR(forw_back_mac_muldEe):  simcore_mac_0_U ("simcore_mac_0_U") {
