...
// ==============================================================
#ifndef __forw_back_fptrunceOg__HH__
#define __forw_back_fptrunceOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_fptrunceOg) {
    ...
    SC_CTOR(forw_back_fptrunceOg):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
