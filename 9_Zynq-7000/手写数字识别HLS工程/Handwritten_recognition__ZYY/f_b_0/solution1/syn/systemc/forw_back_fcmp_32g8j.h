...
// ==============================================================
#ifndef __forw_back_fcmp_32g8j__HH__
#define __forw_back_fcmp_32g8j__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_fcmp_32g8j) {
    ...
    SC_CTOR(forw_back_fcmp_32g8j):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
