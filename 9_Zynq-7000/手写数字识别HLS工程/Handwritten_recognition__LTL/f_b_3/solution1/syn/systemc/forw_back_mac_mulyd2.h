...
// ==============================================================
#ifndef __forw_back_mac_mulyd2__HH__
#define __forw_back_mac_mulyd2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_mac_mulyd2) {
    ...
    SC_CTOR(forw_back_mac_mulyd2):  simcore_mac_3_U ("simcore_mac_3_U") {
