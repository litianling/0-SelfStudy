...
set C_modelName {OverturnKernel}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_matrix float 32 regular {array 9 { 1 3 } 1 1 }  }
	{ output_matrix float 32 regular {array 9 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	output_matrix { ap_memory {  { output_matrix_address0 mem_address 1 4 }  { output_matrix_ce0 mem_ce 1 1 }  { output_matrix_we0 mem_we 1 1 }  { output_matrix_d0 mem_din 1 32 } } }
}
