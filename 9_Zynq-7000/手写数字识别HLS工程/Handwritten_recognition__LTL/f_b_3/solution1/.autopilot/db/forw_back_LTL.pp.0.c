# 1 "f_b_1/forw_back_LTL.c"
# 1 "f_b_1/forw_back_LTL.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
#pragma HLS RESOURCE variable=&fc_hidden_layer2 core=RAM_2P_LUTRAM
# 60 "f_b_1/forw_back_LTL.c"

    MatrixBackPropagationMultiply_label2:for(int i=0;i<w;i++)
#pragma HLS PIPELINE
# 61 "f_b_1/forw_back_LTL.c"
...
#pragma HLS RESOURCE variable=&fc_hidden_layer2 core=RAM_2P_LUTRAM
# 82 "f_b_1/forw_back_LTL.c"

    OverturnKernel_label4:for(int i=0;i<k;i++)
        for(int j=0;j<k;j++)
...
#pragma HLS RESOURCE variable=&fc_hidden_layer2 core=RAM_2P_LUTRAM
# 88 "f_b_1/forw_back_LTL.c"

    Padding_label5:for(int i=0;i<w+2*stride;i++)
#pragma HLS PIPELINE
# 89 "f_b_1/forw_back_LTL.c"
...
# 185 "f_b_1/forw_back_LTL.c"

#pragma HLS INTERFACE s_axilite port=&lr bundle=ctrl
# 185 "f_b_1/forw_back_LTL.c"

#pragma HLS RESOURCE variable=return core=RAM_2P_LUTRAM
# 185 "f_b_1/forw_back_LTL.c"
