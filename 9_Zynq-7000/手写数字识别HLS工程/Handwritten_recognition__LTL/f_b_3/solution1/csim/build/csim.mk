...
HLS_SOURCES = ../../../main.c ../../../../f_b_1/forw_back_LTL.c
...
$(ObjDir)/forw_back_LTL.o: ../../../../f_b_1/forw_back_LTL.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../f_b_1/forw_back_LTL.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/forw_back_LTL.d
