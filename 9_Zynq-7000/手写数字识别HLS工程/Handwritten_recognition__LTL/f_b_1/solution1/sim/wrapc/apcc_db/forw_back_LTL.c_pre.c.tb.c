...
printf("\n\{ BEGIN @forw_back\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = bitcast float* %%in to i8*, !dbg !16 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1049_count);
  llvm_cbe_tmp__333 = ( char *)(( char *)llvm_cbe_in);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i8* @memcpy(i8* bitcast ([30 x [30 x float]]* @aesl_internal_mnist_data to i8*), i8* %%1, i64 3600 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1050_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_mnist_data)), ( char *)llvm_cbe_tmp__333, 3600ull);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%3 = bitcast float* %%conv1 to i8*, !dbg !17 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1051_count);
  llvm_cbe_tmp__335 = ( char *)(( char *)llvm_cbe_conv1);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = call i8* @memcpy(i8* bitcast ([3 x [3 x float]]* @aesl_internal_conv_kernel_1 to i8*), i8* %%3, i64 36 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1052_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_conv_kernel_1)), ( char *)llvm_cbe_tmp__335, 36ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",36ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__336);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = bitcast float* %%conv2 to i8*, !dbg !17 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1053_count);
  llvm_cbe_tmp__337 = ( char *)(( char *)llvm_cbe_conv2);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = call i8* @memcpy(i8* bitcast ([3 x [3 x float]]* @aesl_internal_conv_kernel_2 to i8*), i8* %%5, i64 36 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1054_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_conv_kernel_2)), ( char *)llvm_cbe_tmp__337, 36ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",36ull);
...
printf("\n  %%7 = bitcast float* %%conv3 to i8*, !dbg !18 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1055_count);
  llvm_cbe_tmp__339 = ( char *)(( char *)llvm_cbe_conv3);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = call i8* @memcpy(i8* bitcast ([3 x [3 x float]]* @aesl_internal_conv_kernel_3 to i8*), i8* %%7, i64 36 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1056_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_conv_kernel_3)), ( char *)llvm_cbe_tmp__339, 36ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",36ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__340);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = bitcast float* %%fc1 to i8*, !dbg !18 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1057_count);
  llvm_cbe_tmp__341 = ( char *)(( char *)llvm_cbe_fc1);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = call i8* @memcpy(i8* bitcast ([576 x [180 x float]]* @aesl_internal_fc_hidden_layer1 to i8*), i8* %%9, i64 414720 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1058_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_fc_hidden_layer1)), ( char *)llvm_cbe_tmp__341, 414720ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",414720ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__342);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = bitcast float* %%fc2 to i8*, !dbg !18 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1059_count);
  llvm_cbe_tmp__343 = ( char *)(( char *)llvm_cbe_fc2);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = call i8* @memcpy(i8* bitcast ([180 x [45 x float]]* @aesl_internal_fc_hidden_layer2 to i8*), i8* %%11, i64 32400 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1060_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_fc_hidden_layer2)), ( char *)llvm_cbe_tmp__343, 32400ull);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%13 = bitcast float* %%fc3 to i8*, !dbg !19 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1061_count);
  llvm_cbe_tmp__345 = ( char *)(( char *)llvm_cbe_fc3);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = call i8* @memcpy(i8* bitcast ([45 x [10 x float]]* @aesl_internal_fc_hidden_layer3 to i8*), i8* %%13, i64 1800 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1062_count);
  ( char *)memcpy(( char *)(( char *)(&aesl_internal_fc_hidden_layer3)), ( char *)llvm_cbe_tmp__345, 1800ull);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__357:
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @forward(), !dbg !20 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1065_count);
   /*tail*/ forward();
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = bitcast float* %%out to i8*, !dbg !19 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1066_count);
  llvm_cbe_tmp__347 = ( char *)(( char *)llvm_cbe_out);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i8* @memcpy(i8* %%17, i8* bitcast ([10 x float]* @aesl_internal_probability_result to i8*), i64 40 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1067_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = bitcast float* %%out to i8*, !dbg !19 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1072_count);
  llvm_cbe_tmp__349 = ( char *)(( char *)llvm_cbe_out);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = call i8* @memcpy(i8* %%20, i8* bitcast ([10 x float]* @aesl_internal_probability_result to i8*), i64 40 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1073_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__349, ( char *)(( char *)(&aesl_internal_probability_result)), 40ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",40ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__350);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i8* @memcpy(i8* %%3, i8* bitcast ([3 x [3 x float]]* @aesl_internal_conv_kernel_1 to i8*), i64 36 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1074_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__335, ( char *)(( char *)(&aesl_internal_conv_kernel_1)), 36ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",36ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__351);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = call i8* @memcpy(i8* %%5, i8* bitcast ([3 x [3 x float]]* @aesl_internal_conv_kernel_2 to i8*), i64 36 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1075_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__337, ( char *)(( char *)(&aesl_internal_conv_kernel_2)), 36ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",36ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__352);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = call i8* @memcpy(i8* %%7, i8* bitcast ([3 x [3 x float]]* @aesl_internal_conv_kernel_3 to i8*), i64 36 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1076_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__339, ( char *)(( char *)(&aesl_internal_conv_kernel_3)), 36ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",36ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__353);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = call i8* @memcpy(i8* %%9, i8* bitcast ([576 x [180 x float]]* @aesl_internal_fc_hidden_layer1 to i8*), i64 414720 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1077_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__341, ( char *)(( char *)(&aesl_internal_fc_hidden_layer1)), 414720ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",414720ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__354);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = call i8* @memcpy(i8* %%11, i8* bitcast ([180 x [45 x float]]* @aesl_internal_fc_hidden_layer2 to i8*), i64 32400 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1078_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__343, ( char *)(( char *)(&aesl_internal_fc_hidden_layer2)), 32400ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",32400ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__355);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i8* @memcpy(i8* %%13, i8* bitcast ([45 x [10 x float]]* @aesl_internal_fc_hidden_layer3 to i8*), i64 1800 for 0x%I64xth hint within @forw_back  --> \n", ++aesl_llvm_cbe_1079_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__345, ( char *)(( char *)(&aesl_internal_fc_hidden_layer3)), 1800ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",1800ull);
