...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "forw_back.autotvin.dat"
	set constFileTvOut       "forw_back.autotvout.dat"
	set constFileHdlTvIn     "forw_back.autohdltvin.dat"
	set constFileHdlTvOut    "forw_back.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
