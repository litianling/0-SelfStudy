...
// ==============================================================
#ifndef __forw_back_mac_mulmb6__HH__
#define __forw_back_mac_mulmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_mac_mulmb6) {
    ...
    SC_CTOR(forw_back_mac_mulmb6):  simcore_mac_2_U ("simcore_mac_2_U") {
