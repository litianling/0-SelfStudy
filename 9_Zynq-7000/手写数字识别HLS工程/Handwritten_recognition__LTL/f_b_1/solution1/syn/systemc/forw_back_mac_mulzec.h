...
// ==============================================================
#ifndef __forw_back_mac_mulzec__HH__
#define __forw_back_mac_mulzec__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_mac_mulzec) {
    ...
    SC_CTOR(forw_back_mac_mulzec):  simcore_mac_4_U ("simcore_mac_4_U") {
