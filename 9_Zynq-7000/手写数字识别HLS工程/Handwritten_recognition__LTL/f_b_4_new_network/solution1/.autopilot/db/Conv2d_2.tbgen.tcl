...
set C_modelArgList {
	{ kernel float 32 regular {array 144 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ kernel_address0 sc_out sc_lv 8 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_fadd_32bkb_U59", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.forw_back_fmul_32cud_U60", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	kernel { ap_memory {  { kernel_address0 mem_address 1 8 }  { kernel_ce0 mem_ce 1 1 }  { kernel_q0 mem_dout 0 32 } } }
