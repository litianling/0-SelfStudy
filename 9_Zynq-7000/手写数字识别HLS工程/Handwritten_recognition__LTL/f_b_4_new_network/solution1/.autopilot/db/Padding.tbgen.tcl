...
set C_modelArgList {
	{ input_matrix float 32 regular {array 144 { 1 1 } 1 1 }  }
	{ output_matrix float 32 regular {array 256 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ input_matrix_address1 sc_out sc_lv 8 signal 0 } 
	{ input_matrix_ce1 sc_out sc_logic 1 signal 0 } 
	{ input_matrix_q1 sc_in sc_lv 32 signal 0 } 
	{ output_matrix_address0 sc_out sc_lv 8 signal 1 } 
	...
	{ output_matrix_address1 sc_out sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_matrix_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "input_matrix", "role": "address1" }} , 
 	...
 	{ "name": "output_matrix_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "output_matrix", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	input_matrix { ap_memory {  { input_matrix_address0 mem_address 1 8 }  { input_matrix_ce0 mem_ce 1 1 }  { input_matrix_q0 mem_dout 0 32 }  { input_matrix_address1 MemPortADDR2 1 8 }  { input_matrix_ce1 MemPortCE2 1 1 }  { input_matrix_q1 MemPortDOUT2 0 32 } } }
	output_matrix { ap_memory {  { output_matrix_address0 mem_address 1 8 }  { output_matrix_ce0 mem_ce 1 1 }  { output_matrix_we0 mem_we 1 1 }  { output_matrix_d0 mem_din 1 32 }  { output_matrix_address1 MemPortADDR2 1 8 }  { output_matrix_ce1 MemPortCE2 1 1 }  { output_matrix_we1 MemPortWE2 1 1 }  { output_matrix_d1 MemPortDIN2 1 32 } } }
}
