...
wire   [31:0] zext_ln41_4_fu_241_p1;
reg   [31:0] zext_ln41_4_reg_582;
wire   [6:0] sub_ln45_fu_257_p2;
reg   [6:0] sub_ln45_reg_587;
wire   [2:0] j_fu_273_p2;
reg   [2:0] j_reg_595;
wire    ap_CS_fsm_state3;
wire   [31:0] zext_ln42_fu_287_p1;
reg   [31:0] zext_ln42_reg_600;
wire   [0:0] icmp_ln39_fu_267_p2;
wire   [31:0] zext_ln42_2_fu_297_p1;
reg   [31:0] zext_ln42_2_reg_605;
reg   [5:0] output_matrix_addr_reg_610;
reg   [5:0] locate_matrix_addr_reg_615;
wire   [31:0] sub_ln43_fu_333_p2;
reg   [31:0] sub_ln43_reg_623;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln41_fu_316_p2;
wire   [31:0] col_2_fu_344_p2;
...
reg   [31:0] conv_out_2_load_reg_652;
wire    ap_CS_fsm_state9;
wire   [0:0] icmp_ln43_5_fu_377_p2;
reg   [0:0] icmp_ln43_5_reg_658;
wire   [0:0] icmp_ln43_6_fu_383_p2;
reg   [0:0] icmp_ln43_6_reg_663;
wire   [7:0] tmp_V_fu_392_p4;
reg   [7:0] tmp_V_reg_668;
wire    ap_CS_fsm_state10;
wire   [22:0] tmp_V_2_fu_402_p1;
reg   [22:0] tmp_V_2_reg_674;
wire   [0:0] and_ln43_2_fu_434_p2;
reg   [0:0] and_ln43_2_reg_679;
reg   [0:0] p_Result_s_reg_683;
wire   [31:0] row_2_fu_563_p2;
...
wire   [31:0] p_Val2_12_fu_555_p3;
reg   [31:0] max_num_2_reg_183;
wire   [63:0] zext_ln45_fu_310_p1;
wire  signed [63:0] sext_ln43_fu_355_p1;
reg   [31:0] grp_fu_195_p0;
wire   [3:0] col_fu_219_p3;
wire   [3:0] add_ln41_fu_235_p2;
wire   [5:0] shl_ln_fu_245_p3;
wire   [6:0] zext_ln45_2_fu_253_p1;
wire   [6:0] zext_ln41_3_fu_231_p1;
wire   [3:0] row_fu_279_p3;
wire   [3:0] add_ln42_fu_291_p2;
wire   [6:0] j_0_cast3_fu_263_p1;
wire   [6:0] add_ln45_fu_301_p2;
wire  signed [31:0] sext_ln45_fu_306_p1;
wire   [31:0] shl_ln43_fu_321_p2;
wire   [31:0] shl_ln43_2_fu_327_p2;
wire   [31:0] bitcast_ln43_2_fu_360_p1;
wire   [7:0] tmp_14_fu_363_p4;
wire   [22:0] trunc_ln43_2_fu_373_p1;
wire   [31:0] p_Val2_s_fu_389_p1;
wire   [0:0] icmp_ln43_4_fu_412_p2;
wire   [0:0] icmp_ln43_fu_406_p2;
wire   [0:0] or_ln43_fu_418_p2;
wire   [0:0] or_ln43_2_fu_424_p2;
...
wire  signed [31:0] sext_ln1311_2_fu_495_p1;
wire  signed [24:0] sext_ln1311_3_fu_499_p1;
wire   [78:0] zext_ln682_fu_457_p1;
wire   [78:0] zext_ln1287_fu_503_p1;
wire   [24:0] r_V_fu_507_p2;
wire   [0:0] tmp_8_fu_519_p3;
wire   [78:0] r_V_2_fu_513_p2;
wire   [31:0] zext_ln662_fu_527_p1;
wire   [31:0] tmp_11_fu_531_p4;
wire   [31:0] p_Val2_11_fu_541_p3;
wire   [31:0] result_V_2_fu_549_p2;
reg   [15:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'd0 == and_ln43_2_fu_434_p2) & (1'b1 == ap_CS_fsm_state10))) begin
        max_num_2_reg_183 <= max_num_1_reg_161;
    end else if (((1'd1 == and_ln43_2_reg_679) & (1'b1 == ap_CS_fsm_state13))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln39_fu_267_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        zext_ln42_2_reg_605[3 : 1] <= zext_ln42_2_fu_297_p1[3 : 1];
        zext_ln42_reg_600[3 : 1] <= zext_ln42_fu_287_p1[3 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'd1 == and_ln43_2_fu_434_p2) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln38_fu_207_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        sub_ln45_reg_587[6 : 1] <= sub_ln45_fu_257_p2[6 : 1];
        zext_ln41_4_reg_582[3 : 1] <= zext_ln41_4_fu_241_p1[3 : 1];
        zext_ln41_reg_577[3 : 1] <= zext_ln41_fu_227_p1[3 : 1];
    end
end
...
always @ (*) begin
    if (((1'd1 == and_ln43_2_reg_679) & (1'b1 == ap_CS_fsm_state13))) begin
...
assign add_ln41_fu_235_p2 = (col_fu_219_p3 + 4'd2);

assign add_ln42_fu_291_p2 = (row_fu_279_p3 + 4'd2);

assign add_ln43_fu_350_p2 = (row_0_reg_173 + sub_ln43_reg_623);

assign add_ln45_fu_301_p2 = (j_0_cast3_fu_263_p1 + sub_ln45_reg_587);

assign and_ln43_2_fu_434_p2 = (grp_fu_202_p2 & and_ln43_fu_428_p2);

assign and_ln43_fu_428_p2 = (or_ln43_fu_418_p2 & or_ln43_2_fu_424_p2);
...
assign bitcast_ln43_2_fu_360_p1 = tmp_s_reg_646;

assign col_2_fu_344_p2 = (col_0_reg_151 + 32'd1);

assign col_fu_219_p3 = {{i_0_reg_117}, {1'd0}};

assign conv_out_2_address0 = sext_ln43_fu_355_p1;

assign i_fu_213_p2 = (i_0_reg_117 + 3'd1);

assign icmp_ln38_fu_207_p2 = ((i_0_reg_117 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln39_fu_267_p2 = ((j_0_reg_128 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln41_fu_316_p2 = (($signed(col_0_reg_151) < $signed(zext_ln41_4_reg_582)) ? 1'b1 : 1'b0);

assign icmp_ln42_fu_339_p2 = (($signed(row_0_reg_173) < $signed(zext_ln42_2_reg_605)) ? 1'b1 : 1'b0);

assign icmp_ln43_4_fu_412_p2 = ((tmp_V_2_fu_402_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln43_5_fu_377_p2 = ((tmp_14_fu_363_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln43_6_fu_383_p2 = ((trunc_ln43_2_fu_373_p1 == 23'd0) ? 1'b1 : 1'b0);
...
assign j_fu_273_p2 = (j_0_reg_128 + 3'd1);

assign locate_matrix_address0 = locate_matrix_addr_reg_615;

assign locate_matrix_d0 = grp_fu_195_p1;

assign mantissa_V_fu_448_p4 = {{{{1'd1}, {tmp_V_2_reg_674}}}, {1'd0}};

assign or_ln43_2_fu_424_p2 = (icmp_ln43_6_reg_663 | icmp_ln43_5_reg_658);

assign or_ln43_fu_418_p2 = (icmp_ln43_fu_406_p2 | icmp_ln43_4_fu_412_p2);

assign output_matrix_address0 = output_matrix_addr_reg_610;

assign output_matrix_d0 = grp_fu_195_p1;

assign p_Val2_11_fu_541_p3 = ((isNeg_fu_470_p3[0:0] === 1'b1) ? zext_ln662_fu_527_p1 : tmp_11_fu_531_p4);

assign p_Val2_12_fu_555_p3 = ((p_Result_s_reg_683[0:0] === 1'b1) ? result_V_2_fu_549_p2 : p_Val2_11_fu_541_p3);

assign p_Val2_s_fu_389_p1 = conv_out_2_load_reg_652;

assign r_V_2_fu_513_p2 = zext_ln682_fu_457_p1 << zext_ln1287_fu_503_p1;

assign r_V_fu_507_p2 = mantissa_V_fu_448_p4 >> sext_ln1311_3_fu_499_p1;

assign result_V_2_fu_549_p2 = (32'd0 - p_Val2_11_fu_541_p3);

assign row_2_fu_563_p2 = (row_0_reg_173 + 32'd1);

assign row_fu_279_p3 = {{j_0_reg_128}, {1'd0}};

assign sext_ln1311_2_fu_495_p1 = ush_fu_487_p3;

assign sext_ln1311_3_fu_499_p1 = ush_fu_487_p3;
...
assign shl_ln43_2_fu_327_p2 = col_0_reg_151 << 32'd2;

assign shl_ln43_fu_321_p2 = col_0_reg_151 << 32'd4;

assign shl_ln_fu_245_p3 = {{i_0_reg_117}, {3'd0}};

assign sub_ln1311_fu_478_p2 = (8'd127 - tmp_V_reg_668);

assign sub_ln43_fu_333_p2 = (shl_ln43_fu_321_p2 - shl_ln43_2_fu_327_p2);

assign sub_ln45_fu_257_p2 = (zext_ln45_2_fu_253_p1 - zext_ln41_3_fu_231_p1);

assign tmp_11_fu_531_p4 = {{r_V_2_fu_513_p2[55:24]}};

assign tmp_14_fu_363_p4 = {{bitcast_ln43_2_fu_360_p1[30:23]}};

assign tmp_8_fu_519_p3 = r_V_fu_507_p2[32'd24];

assign tmp_V_2_fu_402_p1 = p_Val2_s_fu_389_p1[22:0];

assign tmp_V_fu_392_p4 = {{p_Val2_s_fu_389_p1[30:23]}};

assign trunc_ln43_2_fu_373_p1 = bitcast_ln43_2_fu_360_p1[22:0];

assign ush_fu_487_p3 = ((isNeg_fu_470_p3[0:0] === 1'b1) ? sext_ln1311_fu_483_p1 : add_ln339_fu_464_p2);

assign zext_ln1287_fu_503_p1 = $unsigned(sext_ln1311_2_fu_495_p1);

assign zext_ln339_fu_461_p1 = tmp_V_reg_668;

assign zext_ln41_3_fu_231_p1 = col_fu_219_p3;

assign zext_ln41_4_fu_241_p1 = add_ln41_fu_235_p2;

assign zext_ln41_fu_227_p1 = col_fu_219_p3;

assign zext_ln42_2_fu_297_p1 = add_ln42_fu_291_p2;

assign zext_ln42_fu_287_p1 = row_fu_279_p3;

assign zext_ln45_2_fu_253_p1 = shl_ln_fu_245_p3;

assign zext_ln45_fu_310_p1 = $unsigned(sext_ln45_fu_306_p1);

assign zext_ln662_fu_527_p1 = tmp_8_fu_519_p3;

assign zext_ln682_fu_457_p1 = mantissa_V_fu_448_p4;

always @ (posedge ap_clk) begin
    zext_ln41_reg_577[0] <= 1'b0;
    zext_ln41_reg_577[31:4] <= 28'b0000000000000000000000000000;
    zext_ln41_4_reg_582[0] <= 1'b0;
    zext_ln41_4_reg_582[31:4] <= 28'b0000000000000000000000000000;
    sub_ln45_reg_587[0] <= 1'b0;
    zext_ln42_reg_600[0] <= 1'b0;
    zext_ln42_reg_600[31:4] <= 28'b0000000000000000000000000000;
    zext_ln42_2_reg_605[0] <= 1'b0;
    zext_ln42_2_reg_605[31:4] <= 28'b0000000000000000000000000000;
