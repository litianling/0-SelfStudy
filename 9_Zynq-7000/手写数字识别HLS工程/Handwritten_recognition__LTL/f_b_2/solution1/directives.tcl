...
############################################################
set_directive_interface -mode s_axilite -bundle ctrl "forw_back_LTL" lr
set_directive_interface -mode m_axi -depth 32 -bundle data "forw_back_LTL" lr
set_directive_resource -core RAM_2P_LUTRAM "forw_back_LTL" return
...
set_directive_resource -core RAM_S2P_LUTRAM "MatrixExtensionImproved" fc_hidden_layer2
set_directive_resource -core RAM_S2P_LUTRAM "MatrixMultiply" fc_hidden_layer2
set_directive_resource -core RAM_S2P_LUTRAM "Relu" fc_hidden_layer2
...
set_directive_resource -core RAM_2P_LUTRAM "Conv2d_AXI_AXI_AP" return
set_directive_resource -core RAM_2P_LUTRAM "Conv2d_AP_AXI_AP" return
