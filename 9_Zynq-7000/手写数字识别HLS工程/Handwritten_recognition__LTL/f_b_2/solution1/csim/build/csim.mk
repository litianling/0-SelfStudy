...
HLS_SOURCES = ../../../main.c ../../../forw_back_LTL_new.c
...
$(ObjDir)/forw_back_LTL_new.o: ../../../forw_back_LTL_new.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../forw_back_LTL_new.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/forw_back_LTL_new.d
