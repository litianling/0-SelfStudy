...
// ==============================================================
#ifndef __forw_back_fptruncg8j__HH__
#define __forw_back_fptruncg8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_fptruncg8j) {
    ...
    SC_CTOR(forw_back_fptruncg8j):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
