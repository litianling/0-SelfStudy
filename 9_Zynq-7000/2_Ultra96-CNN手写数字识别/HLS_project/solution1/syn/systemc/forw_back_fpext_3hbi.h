...
// ==============================================================
#ifndef __forw_back_fpext_3hbi__HH__
#define __forw_back_fpext_3hbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(forw_back_fpext_3hbi) {
    ...
    SC_CTOR(forw_back_fpext_3hbi):  ACMP_fpext_U ("ACMP_fpext_U") {
