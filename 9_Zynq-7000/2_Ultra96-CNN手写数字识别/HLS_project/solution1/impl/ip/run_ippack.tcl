...
set Library     "hls"
set IPName      "forw_back"
set Version     "0.0"
set DisplayName "Forw_back"
set Revision    "0"
...
set sdx_kernel_name "forw_back"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "C:/Users/LTL/Desktop/Handwritten_digit_recognition__LTL_FPGA/f_b_4_new_network/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {forw_back_fadd_32bkb
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 flag W 0x0 "Data signal of flag" {{0 32 flag W 0 "Bit 31 to 0 Data signal of flag"}}} {0x18 in_r W 0x0 "Data signal of in_r" {{0 32 in_r W 0 "Bit 31 to 0 Data signal of in_r"}}} {0x20 conv1 W 0x0 "Data signal of conv1" {{0 32 conv1 W 0 "Bit 31 to 0 Data signal of conv1"}}} {0x28 conv2 W 0x0 "Data signal of conv2" {{0 32 conv2 W 0 "Bit 31 to 0 Data signal of conv2"}}} {0x30 fc1 W 0x0 "Data signal of fc1" {{0 32 fc1 W 0 "Bit 31 to 0 Data signal of fc1"}}} {0x38 fc2 W 0x0 "Data signal of fc2" {{0 32 fc2 W 0 "Bit 31 to 0 Data signal of fc2"}}} {0x40 out_r W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 Data signal of out_r"}}} {0x48 label_r W 0x0 "Data signal of label_r" {{0 32 label_r W 0 "Bit 31 to 0 Data signal of label_r"}}} {0x50 lr W 0x0 "Data signal of lr" {{0 32 lr W 0 "Bit 31 to 0 Data signal of lr"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
