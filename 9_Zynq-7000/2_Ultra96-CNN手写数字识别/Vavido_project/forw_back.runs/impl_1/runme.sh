...
HD_PWD='C:/Users/LTL/Desktop/Handwritten_digit_recognition__ZYY_FPGA/forw_back/forw_back.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log forw_back_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source forw_back_wrapper.tcl -notrace
