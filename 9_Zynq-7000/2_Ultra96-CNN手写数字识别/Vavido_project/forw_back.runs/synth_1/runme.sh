...
HD_PWD='C:/Users/LTL/Desktop/Handwritten_digit_recognition__ZYY_FPGA/forw_back/forw_back.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log forw_back_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source forw_back_wrapper.tcl
